 ...
 * @LastEditTime: 2025-04-30 10:02:11
...
export default function BackgroundRect(_props: BackgroundRectPorpsT) {
  ...
  return (
    <div
      ...
      className={["top-0 w-[calc(25vw)] h-screen", "transition-[transform] will-change-transform duration-700", "flex flex-row gap-2 justify-center"].join(" ")}
    >
      {/* <div className={["bg-amber-200 h-[60px] w-[90%] mt-[10px]"].join(" ")}></div> */}
    </div>
  );
}
